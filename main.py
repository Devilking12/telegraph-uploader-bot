...
ERROR_BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("Report Bugs🤖", url="http://t.me/Devilkingassistant_bot"),
            InlineKeyboardButton("Learn Bot🙂", url="http://t.me/Devilkingassistant_bot")
        ]
    ]
)
...
async def start(bot, message):
    text = f"Hello {message.from_user.first_name}!\n\nWelcome to the Telegraph uploader bot.\nYou can send me any " \
           ...
           f"<a href=http://t.me/Devilkingassistant_bot>Feel free to leave a feedback</a>"
...
async def photo_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            "File must be less than 5mb, please try another file or <a href=http://t.me/Devilkingassistant_bot>LEARN THIS BOT FIRST!</a>",
        ...
        await t.edit_text(
            f"Link - `{generated_link} `\n\n<a href=http://t.me/Devilkingassistant_bot>Feel free to leave a feedback</a>",
...
async def sticker_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            f"❌ This sticker was unable to upload. Please try another file or <a href=http://t.me/Devilkingassistant_bot>LEARN THIS BOT FIRST!</a>\n\n<i>Caused error - {a}</i>",
            reply_markup=INLINE_SELECT,
            disable_web_page_preview=True)
    else:
        t = await msg.edit_text(generated_link, disable_web_page_preview=True)
